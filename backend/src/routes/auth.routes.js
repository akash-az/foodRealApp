...
router.post("/food_partner/register", authController.registerFoodPartner);
router.post("/food_partner/login", authController.loginFoodPartner);
router.get("/food_partner/logout", authController.logoutFoodPartner);
